...
int id=50; String name="ARVDRC"; String ext="png";
int i;void setup(){size(900,900,P3D);}void draw(){while(++i%900>0){translate(450,450);rotateX(i/9);rotateY(i/7);ellipse(400,0,20,20);}}//#p5
